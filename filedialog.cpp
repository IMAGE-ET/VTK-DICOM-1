...
//Width and Height to be used later
	...
	cout<<endl<<"Upper Right Coordinates: "<<upperRightX<<" "<<upperRightY<<endl;
	...
	cout<<endl<<"Lower Left Coordinates: "<<lowerLeftX<<" "<<lowerLeftY<<endl;
...
//Message
	std::cout<<endl<<"Interaction Complete..."<<endl;
	std::cout<<"Press Apply Filter to segment..."<<endl;
...
void FileDialog::segmentation()
{
	//FILTERS APPLIED

//Message
	std::cout<<endl<<"Start of Segmentation..."<<endl;
...
//FILTER 7 - MARKER BASED WATERSHED SEGMENTATION -
	...
	//GENERATE MARKERS
  	...
  	try
		...
		std::cout<<"Segmentation Complete..."<<endl<<endl<<"Press Q to continue..."<<endl;
    	}
  	catch( itk::ExceptionObject & error )
    	{
    		std::cerr << "Error: " << error << std::endl;
