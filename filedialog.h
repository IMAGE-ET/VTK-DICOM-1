...
private:
	...
	const char* p;
    	...
    	double threshold;
    	float setLevel;
	double width, height, lowerLeftX, lowerLeftY, upperRightX, upperRightY, lowerLeftXold, lowerLeftYold, upperRightXold, upperRightYold,wx, wy, URtempX, URtempY, LLtempX, LLtempY;
